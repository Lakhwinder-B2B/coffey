        ...
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="border p-3 border-rounded" data-dismiss="modal" onClick={() => {handleBoxClick('According to grammar expert C. Edward Good, "Helping verbs...enable us to express various conditions: If he could type, he would write the next great American novel. Helping verbs help us express permission: You may go to the movie. Helping verbs help us express one ability to do something: She can play golf extremely well. Helping verbs enable us to ask questions: Do you think he cares? Will he win the race?"') }}>
